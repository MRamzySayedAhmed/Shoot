...
<img src="public/admin/layout/(1).PNG" width="400px" height="400px"></img>
<img src="public/layout/(1).PNG" width="400px" height="400px"></img>
...
<img src="public/admin/layout/(2).PNG" width="400px" height="400px"></img>

* Responsive & Flexible Dahboard to Make All CRUD Operations on the **News** Module.

<img src="public/admin/layout/(3).PNG" width="400px" height="400px"></img>

* The Admin Can Show All News.
* The Admin Can Show the Details of any News When it is Selected.

<img src="public/admin/layout/(7).PNG" width="400px" height="400px"></img>

* The Admin Can Add News in Both Arabic & English Languages.

<img src="public/admin/layout/(8).PNG" width="400px" height="400px"></img>

* The News Created by the Admin is Consisted of Language, Title, Description, Writer & Image.

<img src="public/admin/layout/(10).PNG" width="400px" height="400px"></img>

* The Admin Can Edit News.

<img src="public/admin/layout/(9).PNG" width="400px" height="400px"></img>

* The Admin Can Delete News.
* **Confirmation Message** on Deleting any News.

<img src="public/admin/layout/(11).PNG" width="400px" height="400px"></img>

* The Admin Can Control the Number of News That are Being Shown per Page for Users in the Homepage.

<img src="public/admin/layout/(6).PNG" width="400px" height="400px"></img>
...
<img src="public/admin/layout/(5).PNG" width="400px" height="400px"></img>

* The Admin Can Show The Total Number of News.
* The Admin Can Show The Total Number of Users.

<img src="public/admin/layout/(4).PNG" width="400px" height="400px"></img>

* The User Can Show All News Without Making a Login.

<img src="public/layout/(2).PNG" width="400px" height="400px"></img>
...
<img src="public/layout/(6).PNG" width="400px" height="400px"></img>
<img src="public/layout/(7).PNG" width="400px" height="400px"></img>

* The User Can Easily Move from One Page to Another Using **Pagination** in (**Bootstrap** & **Laravel**).

<img src="public/layout/(3).PNG" width="400px" height="400px"></img>
<img src="public/layout/(4).PNG" width="400px" height="400px"></img>
<img src="public/layout/(7).PNG" width="400px" height="400px"></img>
<img src="public/layout/(8).PNG" width="400px" height="400px"></img>
